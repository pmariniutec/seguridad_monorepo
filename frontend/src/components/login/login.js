      ...
      <div className="bg-gray-900">
        <div className="login container mx-auto w-full max-w-xs items-center pt-12 h-screen">
          <form
            action="chat.html"
            method="GET"
            className="bg-gray-900 shadow-md rounded px-8 pt-8 pb-8 m-4"
          >
            <label className="block text-lg font-bold mb-4 py-2 text-center text-white">
              Messaging App
            </label>
            <div className="mb-4">
            ...
            <button
              id="login"
              onClick={() => this.login()}
              className="btn-primary rounded-full text-white font-bold py-2 px-4 mx-16 rounded text-md focus:outline-none focus:shadow-outline place-self-center"
              type="button"
            >
              Login
            </button>
